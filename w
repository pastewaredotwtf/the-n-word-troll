--[[
  okay look ik u want to skid this but ffs please dont. catvskid#5752
  
  - ask me for permission before using. kthxbye.
]]
...
function library:Introduction()
    ...
    xsx.Text = "powered by catvskid#5752"
    ...
    text.Text = "exclusive doors script by catvskid."
